    ...
    <section className="text-gray-600 body-font pt-16 lg:min-h-75vh">
      ...
      <div className="p-5 mx-auto gap-2 flex flex-col md:pt-12 md:px-7 lg:py-20 lg:flex-row-reverse items-center min-h-fit">
        ...
        >
           ...
           <img
            className="object-cover object-center bg-[#b9aeb6] border-4 border-white pointer-events-none rounded-full backdrop-contrast-200 backdrop-brightness-200"
            alt="Sharvika Barapatre"
            src={require("../assets/Images/zoomed.png")}
          />
        ...
        <div className="lg:flex-grow lg:pr-4 lg:mr-14 flex flex-col md:mb-0 items-center text-center xl:scale-105">
          ...
          >
            Hello , I am <span className="text-dark-orange">Sharvika Barapatre</span>
          </h2>
          <div
            data-aos="zoom-in-up"
            data-aos-duration="1500"
          ...
          >
            &nbsp;
            <Typewriter
              words={["Frontend Developer", "Full Stack Engineer", "Cloud Enthusiasist"]}
              loop={false}
              typeSpeed={100}
              deleteSpeed={100}
              delaySpeed={1000}
          ...
          >
            ...
            Passionate about building applications and solving real-world problems.
          </p>
          <p
            data-aos="zoom-in-up"
            data-aos-duration="2000"
          ...
          >
            I enjoy designing tech websites and applications that are not only visually appealing but also highly functional and user-friendly.
          </p>
          <div
            data-aos="zoom-in-up"
            data-aos-duration="2000"
